...
class SearchDoctorsListViewItem extends StatelessWidget {
  final DoctorDetailsData? doctorsModel;
  const SearchDoctorsListViewItem({super.key, required this.doctorsModel,});
